    ...
    bindCartTable: function () {
        ...
        if ($.cookie("CartList") != null && $.cookie("CartList") != "undefined") {
            ...
            for (var i = 0; i < Cart.list.length; i++) {
                ...
                htmlCat+='<input class="form-control input-sm" type="text" value="1">';
                htmlCat+='<a href="#"><i class="fa fa-caret-up"></i></a>';
                htmlCat+='<a href="#"><i class="fa fa-caret-down"></i></a>';
                htmlCat+='</td>';
                htmlCat+='<td class="price">';
                htmlCat += '<span>' + Util.toMoneyFormat(Cart.list[i].price) * parseInt(Cart.list[i].quantity) + ' đ</span>';
                htmlCat+='</td>';
