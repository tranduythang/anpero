!function (t) {
    ...
    t.fn.ovic_vertical_menu = function () {
        ...
        t(document).on("click", ".ovic-tabs .tab-link a, .ovic-accordion .panel-heading a", function (e) {
            $("#feature-pr-content").html("<strong>Đang tải dữ liệu.</strong>");

            $(this).parents(".ovic-tabs").find(".product-list-owl").removeClass("slick-initialized");
            e.preventDefault();
            var tp= $(this).data("type");
            var a = t(this),
                i = a.data(),
                o = a.attr("href"),
                n = a.closest(".tab-link,.ovic-accordion").find("a.loaded").attr("href"); 1 != i.ajax || a.hasClass("loaded") ? (a.parent().addClass("active").siblings().removeClass("active"), t(o).addClass("active").siblings().removeClass("active"), a.closest(".panel-default").addClass("active").siblings().removeClass("active"), a.closest(".ovic-accordion").find(o).slideDown(400), a.closest(".ovic-accordion").find(".panel-collapse").not(o).slideUp(400), t(o).ovic_animation_tabs(i.animate)) : (t(o).closest(".tab-container,.ovic-accordion").addClass("loading"), a.parent().addClass("active").siblings().removeClass("active"),
                    t.ajax({
                        type: "POST",
                        ...
                        success: function (e) {
                            ...
                            if (e == null || e.trim() == "") {
                                $(element).html("<strong>Sản phẩm đang được cập nhật.</strong>");
                            } else {                                
                                $(element).html(e);
                            }
            ...
            var a = [], i = "", o = t(this), n = o.closest(".product-item").find("img.wp-post-image"), s = o.attr("aria-label"); if (a.duration = ovic_ajax_frontend.growl_duration, a.title = ovic_ajax_frontend.growl_notice_text, o.removeClass("loading"), n.length || (n = o.closest("tr").find(".product-thumbnail img")), n.length || (n = o.closest(".product").find(".woocommerce-product-gallery__wrapper img")), ("undefined" == typeof s || "" === s) && (s = o.closest(".product").find(".summary .product_title").text().trim()), o.closest(".mini_cart_item").length && (n = o.closest(".mini_cart_item").find("a > img"), s = o.closest(".mini_cart_item").find("a:not(.remove)").clone().children().remove().end().text()),
                setTimeout(function () { o.removeClass("added").removeClass("recent-added"), o.next(".added_to_cart").remove() }, 3e3, o), ("undefined" == typeof s || "" === s) && (s = o.closest(".product-item").find(".product_title a").text().trim()), "undefined" != typeof s && "" !== s) { var c = s.indexOf("“") + 1, l = s.indexOf("”"), s = c > 1 ? s.slice(c, l) : s; s = "<span>" + s + "</span>" } else s = ""; n.length && (i = '<figure><img src="' + n.attr("src") + '" alt="' + s + '" class="growl-thumb" /></figure>'), a.message = i + '<p class="growl-content">' + s + e + "</p>", t.growl.notice(a)
