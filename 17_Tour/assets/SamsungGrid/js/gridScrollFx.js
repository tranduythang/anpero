...
;( function( window ) {
    ...
    GridItem.prototype.addCurtain = function () {
        ...
        //} else {
            var r = [15, 45, 75, 105, 135, 165, 195, 225][Math.floor(Math.random() * 8)];
            var g = [15, 45, 75, 105, 135, 165, 195, 225][Math.floor(Math.random() * 8)];
            var b = [15, 45, 75, 105, 135, 165, 195, 225][Math.floor(Math.random() * 8)];
            this.curtain.style.background = 'rgb(' + r + ',' + g + ',' + b + ')';
        //}
